        ...
        return (
            <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-4">
                    <div className={`p-2.5 rounded-lg ${safeColorClass} bg-opacity-10`}>
                ...
                <div className="flex justify-between items-end mb-2">
                    ...
                    <div className="text-right">
                        <p className="text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Receipt</p>
                        <h3 className="text-lg font-bold text-gray-700">{receipt}</h3>
                    </div>
                </div>
                <div className="pt-2 border-t border-gray-50 flex justify-between items-center text-[10px] text-gray-400 hover:text-blue-600 cursor-pointer">
    ...
    const PropertyTypeCard = ({ label, amount, icon: Icon, colorClass }: any) => {
         ...
         return (
            <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center justify-between hover:shadow-md transition-shadow">
                ...
                <div className="text-[10px] text-gray-400 self-end">Month-till-date</div>
            </div>
         );
    };
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-8 p-2">
            ...
            <section>
                <h3 className="text-sm font-bold text-gray-600 mb-3 flex items-center gap-2">
                    Total Collection <span className="text-gray-400 font-normal text-xs">(UCC + On-Demand UCC)</span>
                </h3>
             ...
             {/* UCC Section */}
             <section>
                <h3 className="text-sm font-bold text-gray-600 mb-3">UCC</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {collectionStats.map((stat, i) => (
            ...
            {/* Property Type Section */}
             <section>
                <h3 className="text-sm font-bold text-gray-600 mb-3">Collection by Property Type</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
             ...
             <section>
                <h3 className="text-sm font-bold text-gray-600 mb-3">On Demand UCC</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {collectionStats.map((stat, i) => (
            ...
            {/* Reports & Actions */}
             <div className="flex flex-col sm:flex-row justify-between items-end gap-4 border-b border-gray-200 pb-4">
                 <div className="flex gap-2 bg-gray-100 p-1 rounded-lg">
                     <button className="px-4 py-2 bg-white text-[#10b981] shadow-sm rounded-md text-sm font-bold">UCC</button>
                     <button className="px-4 py-2 text-gray-500 rounded-md text-sm font-medium hover:bg-gray-200">On Demand UCC</button>
                 </div>
                 
                 <div className="flex flex-wrap gap-2">
                      <button className="flex items-center gap-1.5 px-3 py-2 bg-cyan-50 border border-cyan-100 text-cyan-700 text-xs font-medium rounded-lg hover:bg-cyan-100">
                                ...
                                filteredCharges.map((charge, index) => {
                                    ...
                                    return (
                                        <tr key={charge.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-4 py-3 border-r border-gray-100 text-xs font-medium">{charge.receiptNumber || 'N/A'}</td>
                                            <td className="px-4 py-3 border-r border-gray-100 text-xs">{charge.customerId || 'N/A'}</td>
                                            ...
                                            <td className="px-4 py-3 border-r border-gray-100 text-xs">₹{charge.amount || 0}</td>
